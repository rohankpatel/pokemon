...
const u32 gTrainerFrontPic_DrReynolds[] = INCBIN_U32("graphics/trainers/front_pics/drreynolds_front_pic.4bpp.lz");
const u32 gTrainerPalette_DrReynolds[] = INCBIN_U32("graphics/trainers/palettes/drreynolds.gbapal.lz");
