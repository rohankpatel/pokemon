...
const u32 gObjectEventPic_DrReynolds[] = INCBIN_U32("graphics/object_events/pics/people/drreynolds.4bpp");
const u16 gObjectEventPal_DrReynolds[] = INCBIN_U16("graphics/object_events/palettes/drreynolds.gbapal");